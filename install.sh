...
for file in $FILES
do
  echo "$(eval echo ~$USER)/.$(basename $file) checking..."
...
ln -s $DOTFILES/zsh/custom/themes/robbyrussell.zsh-theme ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/robbyrussell.zsh-theme
